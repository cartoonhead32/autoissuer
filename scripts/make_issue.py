...
Generate:
1. A professional, concise summary of what was done in list form (Markdown format) to be used as an issue description. Limit the summary to at most 3-5 high-level bullet points summarizing the core functional changes, keeping it brief and to the point.
